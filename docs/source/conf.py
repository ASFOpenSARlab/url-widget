...
# -*- coding: utf-8 -*-
#
# url_widget documentation build configuration file
#
...
project = 'url_widget'
copyright = '2021, Alex Lewandowski'
...
_version_py = os.path.join(repo, 'url_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'url_widgetdoc'
...
latex_documents = [
    (master_doc, 'url_widget.tex', 'url_widget Documentation',
     'Alex Lewandowski', 'manual'),
]
